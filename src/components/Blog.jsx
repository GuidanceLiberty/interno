    ...
    <section className='z-20 mt-[80px] lg:mt-[150px]'>
        <div className="container-mx-auto">
            ...
            <div className="blog__grid grid grid-cols-1 lg:grid-cols-3 gap-[27px]">
              <div className="grid__item w-full max-w-[382px] h-[520] border border-primary/20 rounded-[62px] p-[20px] hover:bg-accent-secondary transition-all group cursor-pointer ease-in-out duration-300 mx-auto lg:mx-0">
                <img src={blog_1} alt="" />
